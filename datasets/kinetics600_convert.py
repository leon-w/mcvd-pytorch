...
def make_h5_from_kinetics_multi2(
    kinetics600_dir,
    image_size,
    out_dir="./h5_ds",
...
def make_h5_from_kinetics_multi(
    kinetics600_dir,
    image_size,
    out_dir="./h5_ds",
    vids_per_shard=100000,
...
if __name__ == "__main__":
    ...
    make_h5_from_kinetics_multi2(
        out_dir=os.path.join(args.out_dir, "train"),
        kinetics600_dir=os.path.join(args.k600_targz_dir, "train"),
        image_size=args.image_size,
        vids_per_shard=args.vids_per_shard,
        force_h5=args.force_h5,
        videos_per_class=args.videos_per_class,
        video_idx_per_class=args.video_idx_per_class,
        out_dir2=os.path.join(args.out_dir2, "train"),
        image_size2=args.image_size2,
    )
    make_h5_from_kinetics_multi2(
        out_dir=os.path.join(args.out_dir, "val"),
        kinetics600_dir=os.path.join(args.k600_targz_dir, "val"),
        image_size=args.image_size,
        vids_per_shard=args.vids_per_shard,
        force_h5=args.force_h5,
        videos_per_class=args.videos_per_class,
        video_idx_per_class=args.video_idx_per_class,
        out_dir2=os.path.join(args.out_dir2, "val"),
        image_size2=args.image_size2,
    )
    make_h5_from_kinetics_multi2(
        out_dir=os.path.join(args.out_dir, "test"),
        kinetics600_dir=os.path.join(args.k600_targz_dir, "test"),
        image_size=args.image_size,
        test=True,
        vids_per_shard=args.vids_per_shard,
        force_h5=args.force_h5,
        videos_per_class=args.videos_per_class,
        video_idx_per_class=args.video_idx_per_class,
        out_dir2=os.path.join(args.out_dir2, "test"),
        image_size2=args.image_size2,
    )
